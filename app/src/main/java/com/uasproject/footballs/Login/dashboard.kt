package com.uasproject.footballs.Login
...
import com.uasproject.footballs.league.view.MainActivity
...
class dashboard : AppCompatActivity() {
    ...
    fun postkerserver(data1:String,data2:String)
    {
        ...
        AndroidNetworking.post("http://172.20.10.6/cobalogin/ceklogin.php")
